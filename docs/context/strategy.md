...
- **KDFW (Dallas, LIVE — operator override 2026-06-22):** combined (GEFS+IFS), **UNION** (raw ≥25% OR blend ≥10%), unit **500** (full, KORD/KMIA parity — scaled from 50 same day), decision **17:32Z** (time-of-day study, fill caveat). Live against the OOS-Sharpe>2.5 bar; full-size bet on an unproven OOS edge — see [../decisions/2026-06-22-dallas-live-override.md](../decisions/2026-06-22-dallas-live-override.md).
