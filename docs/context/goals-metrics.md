...
- **Live risk envelope:** KORD, KMIA & **KDFW (Dallas, live 2026-06-22, operator override — scaled to full size same day)** each **$150 daily / $500 cumulative** kill, 500-contract cap; **aggregate $450 daily / $1,500 cumulative**; spread-regime 5¢.
...
| KDFW (Dallas) | $150 | $500 | unit 500, 500-contract cap, edge≥25% raw / 10% blend (UNION), decision 17:32Z. **Live 2026-06-22 as an operator override** of the OOS-Sharpe>2.5 bar; **scaled from minimal 50→full 500 same day** (KORD/KMIA parity) — full-size bet on an unproven OOS edge; see [../decisions/2026-06-22-dallas-live-override.md](../decisions/2026-06-22-dallas-live-override.md) |
| Aggregate | $450 | $1,500 | `AGGREGATE_*` constants (= KORD+KMIA+KDFW); + spread-regime 5¢ |
