...
Live universe: **Chicago + Miami + Dallas** (Dallas live 2026-06-22 at minimal size, **operator override** of the 2.5 OOS-Sharpe bar — see [docs/decisions/2026-06-22-dallas-live-override.md](docs/decisions/2026-06-22-dallas-live-override.md)). Chicago + Miami are the per-city-diagnostic robust cities (2026-06-20); Seattle = monitor (below 2.5 bar), LA/Vegas rejected. Baseline universe doc: [docs/decisions/2026-06-21-live-universe-and-watchlist.md](docs/decisions/2026-06-21-live-universe-and-watchlist.md).
